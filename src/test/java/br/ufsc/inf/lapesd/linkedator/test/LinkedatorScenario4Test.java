...
public class LinkedatorScenario4Test {
    ...
    public void mustCreateExplicitLinkInPoliceRepor() throws IOException {
        ...
        String expectedLink2 = "http://www.w3.org/2002/07/owl#sameAs\":\"10.1.1.1/vitima/654321";
        Assert.assertTrue(linkedRepresentation.contains(expectedLink2));
        
        String expectedLink3 = "http://www.w3.org/2002/07/owl#sameAs\":\"10.1.1.1/vitima/6758493";
        Assert.assertTrue(linkedRepresentation.contains(expectedLink3));
        
        String expectedLink4 = "http://www.w3.org/2002/07/owl#sameAs\":\"10.1.1.1/vitima/4433221111";
    ...
    public void mustCreateInferredLinkInPerson() throws IOException {
        ...
        String expectedLinked1 = "http://www.w3.org/2002/07/owl#sameAs\":\"10.1.1.2/reports/5555";
        Assert.assertTrue(linkedRepresentation.contains(expectedLinked1));
        
        String expectedLinked2 = "http://www.w3.org/2002/07/owl#sameAs\":\"10.1.1.2/reports/666";
